...
void Optimizer::Init()
{
    ...
    curIterModulePosition.resize(movableModuleSize);
    lastIterReferencePosition.resize(movableModuleSize);
    curIterReferencePosition.resize(movableModuleSize);
    ...
    {
        curIterReferencePosition[idx] = placer->ePlaceNodesAndFillers[idx]->getCenter();
        curIterModulePosition[idx] = placer->ePlaceNodesAndFillers[idx]->getCenter();
    }
